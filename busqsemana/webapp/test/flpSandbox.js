		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Busqueda de Semana",
									"targetURL": "#BusquedadeSemana-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"BusquedadeSemana-display": {
								"semanticObject": "BusquedadeSemana",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=busqsemana",
									"url": sap.ui.require.toUrl("busqsemana")
								}
							}
						}
					}
