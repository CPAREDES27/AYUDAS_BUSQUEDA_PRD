		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Busqueda de Armador",
									"targetURL": "#BusquedadeArmador-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"BusquedadeArmador-display": {
								"semanticObject": "BusquedadeArmador",
								"action": "display",
								"description": "Ayuda de búsqueda de armador (proveedor",
								"title": "Busqueda de Armador",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=busqarmadores",
									"url": sap.ui.require.toUrl("busqarmadores")
								}
							}
						}
					}
