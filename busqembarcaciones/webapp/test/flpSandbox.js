		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Búsqueda de embaraciones",
									"targetURL": "#Búsquedadeembaraciones-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Búsquedadeembaraciones-display": {
								"semanticObject": "Búsquedadeembaraciones",
								"action": "display",
								"description": "Ayuda de búsqueda de embaraciones",
								"title": "Búsqueda de embaraciones",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ayudaembarcaciones",
									"url": sap.ui.require.toUrl("ayudaembarcaciones")
								}
							}
						}
					}
