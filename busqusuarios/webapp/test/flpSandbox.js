		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#busqusuarios-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"busqusuarios-display": {
								"semanticObject": "busqusuarios",
								"action": "display",
								"description": "Modulo de ayuda de busqueda",
								"title": "Búsqueda de usuarios",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=busqusuarios",
									"url": sap.ui.require.toUrl("busqusuarios")
								}
							}
						}
					}
