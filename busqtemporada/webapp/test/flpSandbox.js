		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#Búsquedatemporadadepescacuotanacional-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Búsquedatemporadadepescacuotanacional-display": {
								"semanticObject": "Búsquedatemporadadepescacuotanacional",
								"action": "display",
								"description": "Ayuda de búsqueda para temporada de pesca cuota nacional",
								"title": "Búsqueda temporada de pesca cuota nacional",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.tasa.busqtemporada",
									"url": sap.ui.require.toUrl("com/tasa/busqtemporada")
								}
							}
						}
					}
