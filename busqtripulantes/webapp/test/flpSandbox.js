		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Busqueda de Tripulantes",
									"targetURL": "#BusquedadeTripulantes-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"BusquedadeTripulantes-display": {
								"semanticObject": "BusquedadeTripulantes",
								"action": "display",
								"description": "Busqueda de tripulantes",
								"title": "Busqueda de Tripulantes",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=busqtripulantes",
									"url": sap.ui.require.toUrl("busqtripulantes")
								}
							}
						}
					}
